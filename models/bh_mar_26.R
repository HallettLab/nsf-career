...
for(i in species){
  for(j in treatment){
    ...
    ## save model output
    save(PrelimFit, file = paste0("~/Desktop/model_outputs/feb_27_2026/",i,"_",j,"_posteriors_BH", date ,".rdata"))
...
for (i in species2){
  for (j in treatment2){
    if(file.exists(paste0("~/Desktop/model_outputs/feb_27_2026/",i,"_",j,"_posteriors_BH2026-02-27.rdata"))==TRUE){
      load(file=paste0("~/Desktop/model_outputs/feb_27_2026/",i,"_",j,"_posteriors_BH2026-02-27.rdata"))
    } else next
    print(paste("running",i,j,sep = "_"))
    ...
    ggsave(paste0("~/Desktop/model_outputs/diagnostic_figures/feb_27_26/",i,"_",j,"_rhat.pdf"), plot=rhat_plot,device="pdf",width = 10, height = 8)
    
    ### effective sample size
    ess_plot<-stan_ess(PrelimFit)+labs(title = paste0(i,"_",j))### neff to total sample size
    ggsave(paste0("~/Desktop/model_outputs/diagnostic_figures/feb_27_26/",i,"_",j,"_ess.pdf"), plot=ess_plot,device="pdf",width = 10, height = 8)
    ...
    ggsave(paste0("~/Desktop/model_outputs/diagnostic_figures/feb_27_26/",i,"_",j,"_acf.pdf"), plot=ac_plot,device="pdf",width = 10, height = 8)
    ...
    ggsave(paste0("~/Desktop/model_outputs/diagnostic_figures/feb_27_26/",i,"_",j,"_div.pdf"), plot=div,device="pdf",width = 10, height = 8)
    ...
    ggsave(paste0("~/Desktop/model_outputs/diagnostic_figures/feb_27_26/",i,"_",j,"_trace1.pdf"), plot=trace1,device="pdf",width = 10, height = 8)
    ...
    ggsave(paste0("~/Desktop/model_outputs/diagnostic_figures/feb_27_26/",i,"_",j,"_trace2.pdf"), plot=trace2,device="pdf",width = 10, height = 8)
    ...
    ggsave(paste0("~/Desktop/model_outputs/diagnostic_figures/feb_27_26/",i,"_",j,"_dens.pdf"), plot=dens_plots,device="pdf",width = 10, height = 8)
